...
class AdminPanelSettingsController extends Controller
{
    public function index()
    {
        ...
        $data['customer_parent_account_name'] = Accounts::where('account_number', $data['customer_parent_account_number'])->value('name');
        $data['supplier_parent_account_name'] = Accounts::where('account_number', $data['supplier_parent_account_number'])->value('name');
        $data['delegate_parent_account_name'] = Accounts::where('account_number', $data['delegate_parent_account_number'])->value('name');
        $data['employess_parent_account_name'] = Accounts::where('account_number', $data['employess_parent_account_number'])->value('name');
